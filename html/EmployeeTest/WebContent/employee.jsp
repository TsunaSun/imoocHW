		...
		<div class="row">
			...
			<div class="panel panel-default">
				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<c:forEach var="e" items="${applicationScope.employee}"
							varStatus="idx">
							<tr>
								<td>${idx.index+1}</td>
								<td>${e.empno }</td>
								...
								<td>${e.department }</td>
								<td>${e.job }</td>
								<td style="color: red; font-weight: bold">￥<fmt:formatNumber pattern="0,000" value="${e.salary }"/></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/EmployeeTest/AddServlet" method="get">
